...
public class GameFilter implements Filter {
	 ...
	 * L�dt das Spiel und Dispatched den User zu der Index-Seite falls dieser noch nicht bekannt/registriert ist
	 */
	@Override
	public void doFilter(final ServletRequest req, final ServletResponse resp, final FilterChain filterChain) throws IOException, ServletException {
		...
		filterChain.doFilter(req, resp);//n�chsten filter Aufrufen.
	}
	@Override
	public void destroy() {
	}
